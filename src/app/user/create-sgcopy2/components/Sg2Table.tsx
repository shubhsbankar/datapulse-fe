...
export function Sg2Table({ sgs }: Sg2TableProps) {
  ...
  const [visibleColumns, setVisibleColumns] = useState<Set<Sg2Columns>>(
    new Set([...Object.values(Sg2Columns)])
  );
  ...
  const toggleColumn = (column: Sg2Columns) => {
    ...
    <div className="bg-white shadow rounded-lg p-6">
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="relative flex-1 min-w-[200px] max-w-md">
          ...
          <input
            type="text"
            placeholder="Search SG 2 components..."
            value={searchTerm}
